...
Cisco SME licenses: "SME license", "SME liscense", and "SME" when used as a license request are quote requests for LIC-SME with sku_type="license". If multiple terms are named, set modifiers.all_terms=true. Example: "SME license, 1yr and 3yr" → intent="quote", items=[{sku:"LIC-SME",qty:1,sku_type:"license"}], all_terms=true.
...
const PER_TERM_STANDALONE_RE = /^LIC-MV-[135]YR$|^LIC-MT-[135]Y$|^LIC-(ENT|SEC|SDW)-[135]YR$/;
