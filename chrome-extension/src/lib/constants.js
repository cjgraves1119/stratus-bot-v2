...
export const MSG = {
  ...
  EMAIL_RESPONDER_STATE: 'EMAIL_RESPONDER_STATE',
  EMAIL_RESPONDER_TOGGLE: 'EMAIL_RESPONDER_TOGGLE',
  EMAIL_RESPONDER_KILL: 'EMAIL_RESPONDER_KILL',
  EMAIL_RESPONDER_POLL: 'EMAIL_RESPONDER_POLL',
