// Focused test harness for expandFamily() in the GChat worker.
// Mirrors worker/test-expand-family.js so both workers are validated.
...
function buildShim() {
  ...
  // Stub cloudflare:workers runtime so we can require under Node.
...
`;
  ...
  const shimPath = path.join(os.tmpdir(), `stratus-gchat-expand-shim-${process.pid}.cjs`);
...
if (!expandFamily) {
  console.error('❌ expandFamily not exported from worker-gchat/src/index.js');
  process.exit(1);
}
...
const negativeCases = [
  'MS150-24P-4G',
  'MS150-24P',
  'quote an MS150 for me',
  'what is the lead time for MS150',
  'compare MS150 and MS130',
  'drop the MS150 and add MR44',
  'LIC-ENT-3YR, LIC-ENT-5YR',
  'MS150, MS130, MS210',
  '4 MR',
  'MS150\nMS130\nMS210',
  'tell me about MX67',
  'MX75 with the Wifi 7 AP',
  'MX75 and 5 wifi 6 aps',
  'wifi 7 ap',
];
