// EOL SKU swaps — guards the three end-of-sale rules from
// HANDOFF-eol-sku-swaps.md (2026-07-13), implemented 2026-07-21:
...
//
// Run: node worker-gchat/test-eol-sku-swaps-2026-07-21.js
...
function loadEngine(exportNames) {
  ...
  const tmp = path.join(os.tmpdir(), `eol-swaps-${process.pid}.cjs`);
...
(() => {
  ...
  // ── 2. Order-link form through buildStratusUrl (the 23-call-site safety net) ──
